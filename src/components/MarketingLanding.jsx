...
const FEATURES = [
  ...
  { icon: Activity,      tone: "violet",  title: "Guardian timer",      desc: "\"Watch over me until I check in\" — auto-alerts your circle if you miss the timer." },
  { icon: MapPin,        tone: "blue",    title: "Saved places",        desc: "Home, Work, friends — one tap shares 'On my way', 'Arrived', or 'Pick me up'." },
  ...
  { icon: Shield,        tone: "rose",    title: "Self-defense",        desc: "Verified techniques in plain language — escape grabs, what to shout, where to strike." },
  { icon: Ear,           tone: "rose",    title: "Distress listener",   desc: "Auto-SOS when keywords are detected — with a 5-second cancel countdown so a misheard word never fires." },
